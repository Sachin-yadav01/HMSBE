...
public interface PaymentModeRepository extends JpaRepository<PaymentMode, Long> {
    ...
    Optional<PaymentMode> findByIdAndDeletedFalse(Long id);
    ...
    List<PaymentMode> findByActiveTrueAndDeletedFalseOrderByNameAsc();

    @Query("""
        SELECT e FROM PaymentMode e
        ...
        """)
    Page<PaymentMode> search(@Param("searchText") String searchText,
